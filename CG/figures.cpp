...
void getCube(glm::vec3 point1, glm::vec3 point2, glm::vec3 point3, glm::vec3 point4, glm::vec3 color, float * cubeVertices)
{
    ...
    getRectangle(point1, point2, point3, color, cubeVertices + 2 * 6 * 9);
    getRectangle(point4 + point1 - point2, point1, point3 + point1 - point2, color, cubeVertices + 3 * 6 * 9);
    getRectangle(point1 + point3 - point2, point3, point4 + point3 - point2, color, cubeVertices + 4 * 6 * 9);
